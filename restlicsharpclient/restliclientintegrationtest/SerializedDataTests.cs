...
namespace restlicsharpclient.restliclienttest
{
    ...
    public class SerializedDataTests
    {
        ...
        [TestMethod]
        public void NestedCollections_FullCycle_Serialization()
        {
            NestedCollections n;
            ...
            byte[] bytes = DataUtil.MapToBytes(n.Data());

            NestedCollections reclaimed = new NestedCollections(DataUtil.BytesToMap(bytes));
